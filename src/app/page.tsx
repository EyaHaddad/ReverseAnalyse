...
const DEMO_FLOW_CHART = `graph TD
  A[Code Repository] --> B[Trustresponse]
...
const DEMO_SEQUENCE_CHART = `sequenceDiagram
  participant User
  participant Trustresponse
  participant GitHub

  User->>Trustresponse: Enter repository URL
  Trustresponse->>GitHub: Request repository data
  GitHub-->>Trustresponse: Return repository data
  Trustresponse->>Trustresponse: Process and analyze code
  Trustresponse-->>User: Display wiki with diagrams

  %% Add a note to make text more visible
  Note over User,GitHub: Trustresponse supports sequence diagrams for visualizing interactions`;
...
export default function Home() {
  ...
  const [repositoryInput, setRepositoryInput] = useState('https://github.com/EyaHaddad/ReverseAnalyse');
//https://github.com/EyaHaddad/ReverseAnalyse
  const REPO_CONFIG_CACHE_KEY = 'TrustresponseRepoConfigCache';
        ...
        <div
          ...
          <div
            ...
            <div className="grid grid-cols-1 gap-3 text-xs text-[var(--muted)]">
              ...
              <div
                className="bg-[var(--background)]/70 p-3 rounded border border-[var(--border-color)] font-mono overflow-x-hidden whitespace-nowrap"
              >AsyncFuncAI/Trustresponse-open
              </div>
              <div
                className="bg-[var(--background)]/70 p-3 rounded border border-[var(--border-color)] font-mono overflow-x-hidden whitespace-nowrap"
        ...
        <div
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center space-x-5">
              <a href="https://github.com/EyaHaddad/ReverseAnalyse" target="_blank" rel="noopener noreferrer"
