...
const DEMO_FLOW_CHART = `graph TD
  A[Code Repository] --> B[Reverse Analyse]
...
const DEMO_SEQUENCE_CHART = `sequenceDiagram
  participant User
  participant Reverse Analyse
  participant GitHub

  User->>Reverse Analyse: Enter repository URL
  Reverse Analyse->>GitHub: Request repository data
  GitHub-->>Reverse Analyse: Return repository data
  Reverse Analyse->>Reverse Analyse: Process and analyze code
  Reverse Analyse-->>User: Display wiki with diagrams

  %% Add a note to make text more visible
  Note over User,GitHub: Reverse Analyse supports sequence diagrams for visualizing interactions`;
...
export default function Home() {
  ...
  const [repositoryInput, setRepositoryInput] = useState('https://github.com/AsyncFuncAI/Reverse Analyse-open');

  const REPO_CONFIG_CACHE_KEY = 'Reverse AnalyseRepoConfigCache';
        ...
        <div
          ...
          <div
            ...
            <div className="grid grid-cols-1 gap-3 text-xs text-[var(--muted)]">
              ...
              >https://github.com/AsyncFuncAI/Reverse Analyse-open
              </div>
              <div
                className="bg-[var(--background)]/70 p-3 rounded border border-[var(--border-color)] font-mono overflow-x-hidden whitespace-nowrap"
              ...
              <div
                className="bg-[var(--background)]/70 p-3 rounded border border-[var(--border-color)] font-mono overflow-x-hidden whitespace-nowrap"
              >AsyncFuncAI/Reverse Analyse-open
              </div>
              <div
                className="bg-[var(--background)]/70 p-3 rounded border border-[var(--border-color)] font-mono overflow-x-hidden whitespace-nowrap"
        ...
        <div
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center space-x-5">
              <a href="https://github.com/AsyncFuncAI/Reverse Analyse-open" target="_blank" rel="noopener noreferrer"
