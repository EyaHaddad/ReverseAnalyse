...
This is the backend API for Reverse Analyse, providing smart code analysis and AI-powered documentation generation.
...
ReverseAnalyse supports multiple LLM providers. The environment variables above are required depending on which providers you want to use:
...
##### Configuration Files
ReverseAnalyse now uses JSON configuration files to manage various system components instead of hardcoded values:
...
```
ReverseAnalyse_CONFIG_DIR=/path/to/custom/config/dir  # Optional, for custom config file location
```
...
# Request data
payload = {
    "repo_url": "https://github.com/EyaHaddad/ReverseAnalyse",
    "messages": [
        {
            "role": "user",
